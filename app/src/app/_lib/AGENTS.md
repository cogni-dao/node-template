...
- **Exports:** models-cache (getCachedModels, isModelAllowed, getDefaultModelId), auth/session helpers, request-identity resolver + agent key issuer, operator attestation verifier (verifyOperatorAttestation, getOperatorIssuerUrl)
